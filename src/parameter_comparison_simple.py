...
def calculate_gnn_parameters():
    ...
    # GNN layers
    # GCNConv(5, 64): 5 * 64 + 64 = 384
    conv1_params = num_node_features * hidden_channels + hidden_channels
    
    # GATConv(64, 64, heads=4): 64 * 64 * 4 + 64 * 4 = 16,640
    conv2_params = hidden_channels * hidden_channels * 4 + hidden_channels * 4
    
    # GraphConv(256, 64): 256 * 64 + 64 = 16,448
    conv3_params = (hidden_channels * 4) * hidden_channels + hidden_channels
    
    # Edge feature integration
    # Linear(2, 8): 2 * 8 + 8 = 24
    edge_mlp1 = num_edge_features * 8 + 8
    # Linear(8, 1): 8 * 1 + 1 = 9
    edge_mlp2 = 8 * 1 + 1
    
    # Classification head
    # Linear(128, 64): 128 * 64 + 64 = 8,256
    fc1_params = (hidden_channels * 2) * hidden_channels + hidden_channels
    # Linear(64, 32): 64 * 32 + 32 = 2,080
    fc2_params = hidden_channels * 32 + 32
...
if __name__ == "__main__":
    ...
    print()
    print("Detailed GNN Parameter Breakdown:")
    print("- GCNConv(5, 64): {:,}".format(5 * 64 + 64))
    print("- GATConv(64, 64, heads=4): {:,}".format(64 * 64 * 4 + 64 * 4))
    print("- GraphConv(256, 64): {:,}".format(256 * 64 + 64))
    print("- Edge MLP: {:,}".format((2 * 8 + 8) + (8 * 1 + 1)))
    print("- Classification Head: {:,}".format((128 * 64 + 64) + (64 * 32 + 32) + (32 * 2 + 2))) 